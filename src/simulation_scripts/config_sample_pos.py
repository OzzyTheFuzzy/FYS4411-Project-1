...
omega_z    = None    # for elliptical trap set omega_z = beta, for spherical trap set omega_z = None
omega      = 1.0  # harmonic oscillator frequency

""" Monte Carlo parameters"""
write_pos_to_file = True # True if you want to write positions to file and only that
...
nsamples        = int(100)  # amoount of full sets of particle positions
seed            = 142
...
filename            = f'testing{mcmc_alg}.txt' # name of txt file for energies vs alpha during training

     # name of txt file for positions and energies of last sample
""" Gradient descent parameters"""
optimizer = "gd"      # "gd" for gradient descent, "adam" for Adam optimizer
num_iterations  = 30      # different alphas tested
...
name_of_file_positions = f"N{nparticles}_d{dim}_a{a}_pos_E"