...
training_cycles = 5_000 # number of training cycles for each alpha 
num_iterations = 40 # number of different alphas
mcmc_alg = "metropolis" # either user metropolis or metropolis hastings 
backend = "torch"
optimizer = "gd"
batch_size = 200
detailed = True
