...
dim = 3
wf_type = "vmc" 
beta = 0 #2.82843    # for wavefunction with eliptical trap set beta not 0, for spherical trap set beta = 0
...
a = 0.0    # Jastrow factor strength, set to 0 for no interactions and to 0.0043 with for beta=2.82843 to get the same energy as in project 1 for 10 particles in 3D with elliptical trap. For spherical trap set a=0.
