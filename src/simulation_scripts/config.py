...
dim        = 3
wf_type    = "vmc" 
beta       = None    # for wavefunction with eliptical trap set beta 2.82843, for spherical trap set beta = None
...
if beta is None:
    name_of_file        = f"energy_a{a}_N{nparticles}_d{dim}_spherical.txt"  #  name of txt file for energies of last sample
    filename            = f'column_density_a{a}_N{nparticles}_spherical.txt' # name of txt file for column density data
