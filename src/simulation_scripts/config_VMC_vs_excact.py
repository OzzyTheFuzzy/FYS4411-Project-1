...
nchains = 1
eta = 0.01
training_cycles = 100 # number of training cycles for each alpha (Will be scaled with the number of particles in VMC_vs_exact.py)
mcmc_alg = "m"
backend = "torch"
optimizer = "gd"
batch_size = 200
...
alpha_array = np.linspace(0.1, 0.9, 2)
